...
namespace shaiya
{
    ...
    struct Global
    {
        ...
        NpcType npcType;               //0x91AD44  0xDB74
        PAD(26802894);
        ...
        PAD(34);
        Array<BillingItem, 240> bank;  //0x22AB882  0x199E6B2
        // 0x22ABB52  0x199E982
        Array<BillingItem, 240> storedPointItem;
        // 0x22ABE22  0x199EC52
        PAD(1970);
    ...
    struct Static
    {
        ...
        PAD(84796);
        Array<char, MAX_PATH> iniFileName;  //0x7C0720
        // 0x7C0824
        PAD(1416);
        float fogStart;                     //0x7C0DAC
        float fogEnd;                       //0x7C0DB0
        PAD(28);
        Array<char, 16> ipv4;               //0x7C0DD0
        // 0x7C0DE0
        PAD(1468);
        HWND hwnd;                          //0x7C139C
        ...
        PAD(1940);
        // <t>
        Array<char, 512> t;                 //0x7C1B38
        PAD(1024);
        // <s>
        Array<char, 512> s;                 //0x7C2138
        // <p>
        Array<char, 512> p;                 //0x7C2338
        // <i>
        Array<char, 512> i;                 //0x7C2538
        // 0x7C2738
        PAD(4);
        // <v>
        UINT32 v;                           //0x7C273C
        ...
        PAD(21368);
        Array<char, MAX_PATH> exeFileName;  //0x22FF680
        // 0x22FF784
        PAD(708);
